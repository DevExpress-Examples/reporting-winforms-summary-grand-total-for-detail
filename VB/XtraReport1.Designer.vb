...
'			Me.xrlFreightGrandTotal.BeforePrint += New System.Drawing.Printing.PrintEventHandler(Me.xrlFreightGrandTotal_BeforePrint);
			' 
			' DetailReport
			' 
...
'			Me.xrlFreightTotal.SummaryCalculated += New DevExpress.XtraReports.UI.TextFormatEventHandler(Me.xrlFreightTotal_SummaryCalculated);
			' 
			' XtraReport1
			' 
